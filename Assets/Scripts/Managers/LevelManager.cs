...
namespace Manager
{
    public class LevelManager : Singleton<LevelManager>
    {
        ...
        [SerializeField] Text infinityLevel;
        ...
        void LifeCheck()
        {
            ...
            {
                ModeManager.Instance.InfinityScore = level;
                infinityLevel.text = "달성 레벨 " + level;
                if (PlayerPrefs.GetInt("Infinity") < level)
                    PlayerPrefs.SetInt("Infinity", level);
            }
